...
def download_and_extract_ict_files(
    ...
    """
    Download .ict files using an authenticated session.
    The session already holds the ASDC session cookie from the OAuth flow,
    so the download endpoint will accept requests directly.
    """
